...
const allContacts: Contact[] = [
  ...
  // CCM Team
  { usuario: 'Michelle Toscano', email: 'michelle.toscano@mercadolibre.com.mx', role: 'Analista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/elDPYCAAAAE' },
  { usuario: 'Yang Madgiel Castro Zanabria', email: 'yang.castro@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/W1jUYCAAAAE' },
  { usuario: 'Maria Guadalupe Chavez Morales', email: 'maria.chavez@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/G8bRYCAAAAE' },
  { usuario: 'Jorge Alberto Chable Ramirez', email: 'jorge.chable@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/5f3QYCAAAAE' },
  { usuario: 'Samantha Echeverria Roque', email: 'samantha.echeverria@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/nwvQYCAAAAE' },
  { usuario: 'Juan Revilla Torres', email: 'juan.revilla@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/xALQYCAAAAE' },
  { usuario: 'Erick Ulloa', email: 'erick.ulloa@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/PgnQYCAAAAE' },
  { usuario: 'Roberto Carlos Rodriguez Vega', email: 'roberto.rodriguez@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/UfTPYCAAAAE' },
  { usuario: 'Ricardo Javier Solorio Martinez', email: 'ricardo.solorio@mercadolibre.com.mx', role: 'Monitorista CCM', chatUrl: 'https://mail.google.com/chat/u/0/#chat/dm/isaac-hernandez-chat-url' },
